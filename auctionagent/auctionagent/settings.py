"""
Django settings for auctionagent project.
...
# Load .env only when present (local dev)
...
def env_required(name: str) -> str:
    val = os.getenv(name)
    if val is None and os.getenv("DJANGO_ENV") == "production":
        raise RuntimeError(f"Missing required env var: {name}")
    return val



SECRET_KEY = env_required('DJANGOSECRETKEY')
OPENAI_KEY = env_required('OPENAIKEY')
...
WSGI_APPLICATION = 'auctionagent.wsgi.application'
